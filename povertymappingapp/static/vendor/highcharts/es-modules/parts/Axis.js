    ...
    alignToOthers: function () {
        ...
        this.chart.options.chart.alignTicks !== false &&
            ...
            this.chart[this.coll].forEach(function (axis) {
                var othomeimgptions = axis.options, horiz = axis.horiz, key = [
                    horiz ? othomeimgptions.left : othomeimgptions.top,
                    othomeimgptions.width,
                    othomeimgptions.height,
                    othomeimgptions.pane
                ].join(',');
